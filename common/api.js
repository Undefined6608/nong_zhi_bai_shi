...
export function mianFeiTiWenList() {
	let list = [{
			name: "小麦",
			value: 1
		},
...
// load：false：left,true：right
export function msgList() {
	return msglist;
}

export function popList(type, index) {
	let animalList = [{
			id: 1,
